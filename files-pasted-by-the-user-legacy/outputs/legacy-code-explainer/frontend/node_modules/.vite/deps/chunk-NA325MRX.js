import {
  ...
  markers_default,
  positionEdgeLabel
} from "./chunk-CDLGBX24.js";
import {
  insertCluster,
  insertNode,
  labelHelper
} from "./chunk-GUIFEJ7R.js";
import {
  interpolateToCurve
...
var registerDefaultLayoutLoaders = __name(() => {
  registerLayoutLoaders([
    {
      name: "dagre",
      loader: __name(async () => await import("./dagre-VZM6K2ZE-3W7X5WVG.js"), "loader")
    },
    {
      name: "swimlane",
      loader: __name(async () => await import("./swimlanes-SLNWSIFB-W3XKVXMJ.js"), "loader")
    },
    ...true ? [
      {
        name: "cose-bilkent",
        loader: __name(async () => await import("./cose-bilkent-JH36ORCC-SWN7KSOI.js"), "loader")
      }
    ] : []
  ]);
...
//# sourceMappingURL=chunk-NA325MRX.js.map
